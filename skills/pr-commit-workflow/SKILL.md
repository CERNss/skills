...
description: This skill should be used when creating commits or pull requests, enforcing Conventional Commit messages, no emoji or robot prefixes, a human-written PR structure, intent capture, and evidence in agentic workflows.
---
